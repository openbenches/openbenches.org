...
if ($_GET["flickrID"])
{
	...
	https://www.flickr.com/photos/71256895@N00/3397563245
	...
	echo "<textarea name='inscription' cols='70' rows='6'>{$title} {$description}</textarea><br>";
	echo "<img src='{$original}' width='512'/><br>";
	...
	echo '<input type="submit" value="Share Bench" /></form>';

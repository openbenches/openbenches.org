...
?>
	...
	<div id="leaderboard-results">
		<ul class="leaderboard-list">
			...
			<li><a href="https://github.com/select2/select2/">Select2</a> better selection boxes</li>
			<li><a href="https://github.com/Leaflet/Leaflet.markercluster/">Leaflet Marker Cluster</a> plugin for Leaflet </li>
			<li><a href="https://github.com/CliffCloud/Leaflet.Sleep">Leaflet Sleep</a>  prevent unwanted scroll capturing</li>
		</ul>
	</div>

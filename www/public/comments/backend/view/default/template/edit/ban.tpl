...
<div id="edit_ban_page">
    ...
    <form action="index.php?route=edit/ban&amp;id=<?php echo $id; ?>" class="controls" method="post">
        ...
        <div class="buttons">
            ...
            <input type="button" class="button" name="delete" data-id="<?php echo $id; ?>" data-url="manage/bans" value="<?php echo $lang_button_delete; ?>" title="<?php echo $lang_button_delete; ?>">
        </div>
